...
# fine tune
_C.FINE_TUNE = CN()
_C.FINE_TUNE.ANNO_FILE = "train.txt"
_C.FINE_TUNE.YOLO_EPOCHS = 30
_C.FINE_TUNE.LR_INIT = 1e-4
_C.FINE_TUNE.LR_END = 1e-6
_C.FINE_TUNE.WARMUP_EPOCHS = 2
